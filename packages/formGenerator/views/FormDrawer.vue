<template>
  <div>
        ...
        <el-row style="height:100%;overflow:auto">
          <el-col :md="24"
            ...
            <div class="setting"
                 title="资源引用"
                 @click="showResource">
              <el-badge :is-dot="!!resources.length"
                        class="item">
    ...
    <resource-dialog :visible.sync="resourceVisible"
                     :origin-resource="resources"
                     @save="setResource" />
  </div>
</template>
<script>
import { Drawer, Row, Col, Badge, Tabs, TabPane } from 'element-ui'
