<template>
  ...
  >
    ...
    <el-input
      v-if="fields.fieldName && fields.type === 'text'"
    ...
    >
      <el-option
        v-for="item in fields.options && fields.options.length
          ? fields.options
          : options"
        :key="item.value"
        :label="item.label"
    ...
    <el-checkbox
      v-else-if="fields.fieldName && fields.type === 'checkbox'"
      :label="fields.labelText"
      v-model="k[fields.fieldName]"
      v-bind="fields.fieldConfig"
      >{{ fields.label }}</el-checkbox
    >
    <el-checkbox-group
      v-else-if="
        fields.fieldName &&
