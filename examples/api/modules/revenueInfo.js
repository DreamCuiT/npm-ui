...
export const revenueApi = {
  ...
  collectionBudget: [
    ...
    },
    {
      ...
      desc: '经费管理->全周期预算->一级经费拨付经费预算->预算变更'
    }
  ],
  secondaryFunding: [
    {
    ...
    },
    {
      ...
      path: '/product/fund/revenueBudget/getYearNode',
      mockPath: '/product/fund/revenueBudget/getYearNode',
      desc: '经费管理->全周期预算->拨付经费编制->年度列数据及数据权限'
    },
    {
