...
<!--                                <a class="filename" href="\static\download\院年度计划导入模板.xls" download="院年度计划导入模板.xls">院年度计划导入模板.xls</a>-->
                            </span>
                        </p>
                    </li>
                    <li>
...
<script>
    ...
    export default {
        ...
        data () {
            ...
            return {
                saveApi: 'courtyardPlanManager.importExcel',
                checkOutApi: 'courtyardPlanManager.importExcelCheckOut',
                outputIoApi: 'courtyardPlanManager.importExcel',
                dataSource,
        ...
        methods: {
            ...
            customValidate (saveParams) {
                ...
                this.$api['courtyardPlanManager.importExcelCheckOut'](params).then(data => {
                    if (data.length > 0) {
                        let messages = ''
