...
export default {
  ...
  methods: {
    ...
    getProblemDetail (rowId) {
      let that = this
      this.$api['riskManager.getRiskManageById']({ id: rowId }).then(function (res) {
        let data = res
        that.formData.id = data.id
        that.formData.name = data.name
        that.formData.problemDescribe = data.riskDesc
        that.formData.problemTypeDisplay = data.riskType
        that.formData.typeDisplay = data.typeDisplay
        that.formData.introDucer = data.introDucer
        that.formData.introDucerName = data.riskLaunchUser
        that.formData.receiveUserId = data.receiveUserId
        that.formData.receiveUserName = data.riskDutyUser
        that.formData.statusDisplay = data.statusDis
