<template>
  <common-dialog v-if="visibleDialogRoles" :visible.sync="visibleDialogRoles" width="50%" title="选择团队" :dialogConfig="dialogConfig"
    @handle-cancel="dialogRolesCancel" @handle-ok="dialogRolesOk" :dialogHeight="dialogHeight" @close="dialogRolesCancel">
    <template #dialog>
      <div class="dialog-con">
        ...
        <el-tabs v-model="activeName" type="card" @tab-click="handleTabsClick">
          <el-tab-pane label="我的经验团队" name="experience">
            <experience-team v-bind="$attrs" @experience-table-select="experienceSelect"></experience-team>
          </el-tab-pane>
          <el-tab-pane label="标准团队" name="standard">
            <standard-team :tableRefresh="tableRefresh"></standard-team>
          </el-tab-pane>
        </el-tabs>
      </div>
    </template>
