    ...
    <list-layout>
        <template #center>
            <common-tabs :tabsData="tabsData" height="auto" :activeTabs="activeTabs">
                <template #warningInformation v-if="tabsData[0].value == 0">
                    <warning-list  v-model="record" :record="record"></warning-list>
                </template>
                <template #warningInformation v-else>
                    <warning-list  v-model="record" :record="record"></warning-list>
                </template>
                <template #warningSet>
                    <warning-set  v-model="record" :record="record"></warning-set>
                </template>
            </common-tabs>
        </template>
    </list-layout>
