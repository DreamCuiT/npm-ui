    ...
    watch: {
      emData: {
        handler (val, oldValue) {
          ...
          console.log('是否审核制', this.configEmData.decisionForm)
          console.log('是否新项目', this.configEmData.classifyName)
        },
        deep: true,
        immediate: true
      }
      ...
      initCloumn () {
        let tempDataSource = [{
          ...
          },
          {
            ...
            optionUrl: {
              api: 'thirdPartInterface.getDic',
              params: { dicType: 'CORE_SPE' }
            },
            colLayout: 'doubleCol',
            placeholder: '请选择核心专业',
            rules: [{ required: true, message: '请选择核心专业' }]
          },
          {
            type: 'select',
            labelText: '工程技术方向',
            ...
            rules: [{ required: true, message: '请选择工程技术方向' }]
          },
          // {
          //   type: 'select',
          //   labelText: '项目分级',
