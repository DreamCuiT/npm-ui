    ...
    watch: {
      emData: {
        handler (val, oldValue) {
          ...
          console.log('configEmData', this.configEmData)
        },
        deep: true,
        immediate: true
      }
      ...
      initCloumn () {
        let tempDataSource = [
          ...
          },
          {
            ...
            colLayout: 'doubleCol',
            placeholder: '请输入预估数量',
            rules: [{ message: '请输入产品代号' }]
          },
          {
            type: 'number',
            labelText: '预估单价',
            fieldName: 'estimatePrice',
            colLayout: 'doubleCol',
            placeholder: '请输入预估单价',
            rules: [{ message: '请输入产品代号' }]
          },
          ...
          //   rules: [{ required: true, message: '请选择领域主管所领导' }]
          // },
          {
            type: 'select',
            labelText: '领域主管所领导',
          ...
          // },
          {
            ...
            fieldName: 'necessity',
            colLayout: 'doubleCol',
            placeholder: '请输入承揽必要性',
            rules: [{ required: true, message: '请输入承揽必要性' }]
          },
          {
            type: 'text',
            labelText: '关键指标',
            fieldName: 'indicatorWays',
            colLayout: 'doubleCol',
            placeholder: '请输入关键指标'
          },
          {
