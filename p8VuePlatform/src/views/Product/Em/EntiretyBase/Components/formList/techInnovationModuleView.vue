  ...
  export default {
    ...
    methods: {
      ...
      fillData (res) {
        ...
        that.modify.kprojectClassifyname = data.kprojectClassifyname
        that.modify.projectTypeDisplay = data.projectTypeDisplay
        that.modify.mainTechDisplay = data.mainTechDisplay
        that.modify.techDirectionDisplay = data.techDirectionDisplay
