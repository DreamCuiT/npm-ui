    ...
    export default {
        ...
        data () {
            ...
            return {
                ...
                treeParams: {},
                tableApi: 'QualityAnalysisReport.list',
                queryParam: {},
                searchData: [],
                comp: this,
                drawerTitle: null,
        ...
        methods: {
            ...
            createAnalysisReport () {
                this.drawerTitle = '新建质量分析报告'
                this.drawerVisible = true
                this.record = {}
            },
            updateAnalysisReport (record) {
                this.drawerTitle = '修改质量分析报告'
                this.drawerVisible = true
                this.record = record
            },
            removeAnalysisReport (record) {
                let that = this
                this.$confirm('是否确定要删除该质量分析报告？', '提示', {
                    confirmButtonText: '是',
                    cancelButtonText: '否',
                    type: 'warning'
                }).then(() => {
                    that.$api['QualityAnalysisReport.remove']({ id: record.id }).then(res => {
                        if (res && res.data) {
                            that.$message({
