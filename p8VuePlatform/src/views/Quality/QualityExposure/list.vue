    ...
    <list-layout>
        ...
        <template #drawer-panel>
            <common-drawer :title="drawerTitle"
                           ...
                           @close="onDrawerClose">
                <template #drawer>
                    <Exposure-edit v-if="exposureEditVisible" @saveSuccess="saveCallback" :record="record"></Exposure-edit>
                </template>
            </common-drawer>
            <common-drawer :title="drawerTitle"
                           ...
                           @close="onDrawerClose">
                <template #drawer>
                    <Exposure-import v-if="exposureImportVisible" @saveSuccess="saveCallback"></Exposure-import>
                </template>
            </common-drawer>
        </template>
    </list-layout>
...
<script>
    ...
    import ExposureImport from './Components/exposureImport'
    import ExposureEdit from './edit'
    export default {
        name: 'list',
        components: {
            ListLayout,
