            ...
            >
                <template #modelData>
                    <div class="edit-outputdata-view">
                        ...
                        <ul class="file-list" v-for="(item,index) in modelData" :key="item.attId" :class="{ 'not-last': index < modelData.length -1 }">
                            <li >
                                <p>模板下载:
                                    <span class="filename" >
...
<script>
    ...
    export default {
        ...
        data () {
            ...
            return {
                saveApi: 'qualityExposure.importExposure',
                outputIoApi: 'qualityExposure.importExposure',
                dataSource,
                ...
                modelData: [
                    {
                        attId: 'QualityExposure',
                        attFilePath: 'QualityExposure.xlsx',
                        attFileName: '质量曝光导入模板.xlsx',
                        descriptionStr: '按照模板导入数据'
                    }
                ],
