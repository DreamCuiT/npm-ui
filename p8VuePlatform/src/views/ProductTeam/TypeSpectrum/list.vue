  ...
  <normal-layout>
    ...
    <template #center>
      <div id="table-contain">
        ...
        <tree-edit v-if="visibleTreeEdit"
...
export default {
  ...
  data () {
    return {
      ...
      treeParams: {},
      queryParam: {},
      treeApi: 'TypeSpectrum.typeSpectrumTree',
      tableApi: '',
      advanced: false,
      columns: [
        {
      ...
      excelImportData: [
        {
          attId: '8',
          attFilePath: 'Excel型谱管理导入模板.xlsx',
          attFileName: 'Excel型谱管理导入模板',
          descriptionStr: '序号、名称、编号必填'
        }
      ],
      clickedNodeData: {},
