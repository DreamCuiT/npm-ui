    ...
    >
        <template #outputRequest>
            <div class="edit-outputdata-view">
                ...
                <ul class="file-list" v-for="(item,index) in outputRequest" :key="item.attId"
                    :class="{ 'not-last': index < outputRequest.length -1 }">
                    <li>
                        <p>模板下载:
                            <span class="filename">
                               <el-link type="success" :underline="true"
...
<script>
    ...
    export default {
        ...
        data () {
            ...
            return {
                saveApi: 'TypeSpectrum.importExcel',
                outputIoApi: 'TypeSpectrum.importExcel',
                dataSource,
