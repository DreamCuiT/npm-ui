...
<script>
    ...
    let dataSource = [
        ...
        },
        {
            ...
            colLayout: 'singleCol',
            optionUrl: {
                api: 'ExpertDatabaseInformation.productTeamTree',
                label: 'name',
                value: 'id'
            }
        },
    ...
    export default {
        ...
        data () {
            return {
                dataSource: [],
                formData: {},
                saveApi: 'ExpertDatabaseInformation.productTeamSave',
                dialogConfig: {
                    modal: true,
                    appendToBody: true,
        ...
        methods: {
            ...
            getNodeDetail (clickedNodeData) {
                ...
                this.$api['ExpertDatabaseInformation.productTeamGetNodeDetail']({ 'id': nodeId }).then(function (res) {
                    let data = res
