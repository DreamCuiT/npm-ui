...
export const CommandButtonData = [
  ...
  },
  {
    ...
    clickFun: function (btn, ganttName, tasks) {
      ...
      let vueThis = store.getters.vueThis
      api['planGanttManager.changeSwitchType']({ pasteTaskIds: ids, type: '9000' }).then(function (res) {
        let ganttObject = GanttObject.getGanttObject(ganttName)
  ...
  },
  {
    ...
    clickFun: function (btn, ganttName, tasks) {
      ...
      let vueThis = store.getters.vueThis
      api['planGanttManager.changeSwitchType']({ pasteTaskIds: ids, type: '9010' }).then(function (res) {
        let ganttObject = GanttObject.getGanttObject(ganttName)
        ids.forEach(function (id) {
          let selTask = ganttObject.getTask(id)
  ...
  },
  {
    ...
    clickFun: function (btn, ganttName, tasks) {
      ...
      let vueThis = store.getters.vueThis
      api['planGanttManager.changeSwitchType']({ pasteTaskIds: ids, type: '9020' }).then(function (res) {
        let ganttObject = GanttObject.getGanttObject(ganttName)
        ids.forEach(function (id) {
          let selTask = ganttObject.getTask(id)
