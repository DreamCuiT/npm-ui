...
export const repositoryApi = {
  baseData: [
    ...
    },
    {
      name: 'filterListData',
      method: 'POST',
      path: '/product/repository/baseData/filterListData',
      mockPath: '/product/repository/baseData/filterListData',
      desc: '知识库管理->基础数据->筛选列表'
    },
    {
  ...
  commonProjectTree: [
    ...
    {
      name: 'projectTreeByPlan',
      method: 'POST',
      path: '/product/common/P8Tree/planProjectTreelist',
      mockPath: '/product/common/P8Tree/planProjectTreelist',
      desc: '项目结构树查询'
    },
    {
  ...
  PaReport: [
    {
      name: 'saveReport',
      method: 'POST',
      path: '/product/paReport/saveReport',
      mockPath: '/product/paReport/saveReport',
      desc: '项目策划管理-策划数据-删除'
    },
    {
      name: 'getReportList',
      method: 'POST',
      path: '/product/paReport/getReportList',
      mockPath: '/product/paReport/getReportList',
      desc: '项目策划管理-策划数据-删除'
    },
    {
      name: 'getReport',
      method: 'POST',
      path: '/product/paReport/getReport',
      mockPath: '/product/paReport/getReport',
      desc: '项目策划管理-策划数据-删除'
    },
    {
      name: 'deleteById',
      method: 'POST',
      path: '/product/paReport/deleteById',
      mockPath: '/product/paReport/deleteById',
      desc: '项目策划管理-策划数据-删除'
    }
  ],
  Examine: [
    {
      name: 'TreeData',
      method: 'POST',
      path: '/product/Examine/TreeData',
      mockPath: '/product/Examine/TreeData',
      desc: '计划考核-树结构'
    },
    {
      name: 'updateUnitLevel',
      method: 'POST',
      path: '/product/Examine/updateUnitLevel',
      mockPath: '/product/Examine/updateUnitLevel',
      desc: '计划考核-列表数据查询评分维护'
    }
  ],
  Milestone: [
    {
      name: 'saveMilestone',
      method: 'POST',
      path: '/product/pmMilestone/saveMilestone',
      mockPath: '/product/pmMilestone/saveMilestone',
      desc: '里程碑管理-里程碑保存'
    },
    {
      name: 'getByWholeId',
      method: 'POST',
      path: '/product/pmMilestone/getByWholeId',
      mockPath: '/product/pmMilestone/getByWholeId',
      desc: '里程碑管理-里程碑查找'
    }
  ],
  MainJobRisk: [
  ...
  DutyToken: [
    ...
    },
    {
      name: 'checkOnly',
      method: 'POST',
      path: '/product/duty/dutyToken/checkOnly',
      mockPath: '/product/duty/dutyToken/checkOnly',
      desc: '责任令组管理-唯一性校验'
    },
    {
      name: 'copyDutyGroup',
      method: 'POST',
      path: '/product/duty/dutyToken/copyDutyGroup',
      mockPath: '/product/duty/dutyToken/copyDutyGroup',
      desc: '责任令组管理-复制'
    },
    {
      name: 'deleteDuty',
  ...
  ProjectApply: [
    ...
    {
      name: 'functionMenuList',
      method: 'GET',
      path: '/product/bpProjectUseFun/functionMenuList',
      mockPath: '/product/bpProjectUseFun/functionMenuList',
      desc: '立项信息-功能标签动态查询'
    },
    {
      name: 'updateCBB',
      method: 'POST',
      path: '/product/em/wholeDescribe/updateCBB',
      mockPath: '/product/em/wholeDescribe/updateCBB',
      desc: '整体管理-列表数据'
    },
    {
      name: 'updatePatent',
      method: 'POST',
      path: '/product/em/wholeDescribe/updatePatent',
      mockPath: '/product/em/wholeDescribe/updatePatent',
      desc: '整体管理-列表数据'
    },
    {
      name: 'projectList',
    ...
    },
    {
      name: 'getOne',
      method: 'POST',
      path: '/product/em/wholeDescribe/getOne',
      mockPath: '/product/em/wholeDescribe/getOne',
      desc: '整体管理-获取单个'
    },
    {
      name: 'startProcess',
      method: 'POST',
      path: '/product/em/wholeDescribe/startProcess',
      mockPath: '/product/em/wholeDescribe/startProcess',
      desc: '整体管理-发起流程'
    },
    {
      name: 'saveReport',
      method: 'POST',
      path: '/product/em/wholeDescribe/saveReport',
      mockPath: '/product/em/wholeDescribe/saveReport',
      desc: '整体管理-保存立项决策报告'
    },
    {
      name: 'reportTree',
      method: 'POST',
      path: '/product/em/wholeDescribe/reportTree',
      mockPath: '/product/em/wholeDescribe/reportTree',
      desc: '整体管理-决策报告分类树结构'
    },
    {
      name: 'getReport',
      method: 'POST',
      path: '/product/em/wholeDescribe/getReport',
      mockPath: '/product/em/wholeDescribe/getReport',
      desc: '整体管理-查询立项决策报告'
    },
    {
      name: 'reportList',
      method: 'POST',
      path: '/product/em/wholeDescribe/reportList',
      mockPath: '/product/em/wholeDescribe/reportList',
      desc: '整体管理-查询立项决策报告'
    },
    {
      name: 'startProcessByPocessDefinitionKey',
      method: 'POST',
      path: '/product/em/wholeDescribe/startProcessByPocessDefinitionKey',
      mockPath: '/product/em/wholeDescribe/startProcessByPocessDefinitionKey',
      desc: '发布流程任务'
    },
    {
      name: 'getEmConfig',
      method: 'POST',
      path: '/product/em/wholeDescribe/getEmConfig',
      mockPath: '/product/em/wholeDescribe/getEmConfig',
      desc: '获取项目对应的策略'
    },
    {
      name: 'modelTree',
    ...
    {
      name: 'projectClassifyTreeById',
      method: 'POST',
      path: '/product/repository/kprojectClassify/projectClassifyTreeById',
      mockPath: '/product/repository/kprojectClassify/projectClassifyTreeById',
      desc: '项目类型树'
    },
    {
      name: 'fieldModelTree',
    ...
    },
    {
      ...
      mockPath:
        '/bpm/manage/ProcessDefinition/getProcessDefinitionByBusinessId',
    ...
    {
      name: 'getEmConfigById',
      method: 'GET',
      path: '/product/em/wholeDescribe/getEmConfigById',
      mockPath: '/product/em/wholeDescribe/getEmConfigById',
      desc: '获取审批项目属于哪个业务范围'
    },
    {
      name: 'getDisabledValuesArray',
      method: 'POST',
      path: '/product/em/wholeDescribe/getDisabledValuesArray',
      mockPath: '/product/em/wholeDescribe/getDisabledValuesArray',
      desc: '获取不可选择的项目类别的id'
    },
    {
      name: 'withdrawImplementRelease',
      method: 'POST',
      path: '/product/em/wholeDescribe/withdrawImplementRelease',
      mockPath: '/product/em/wholeDescribe/withdrawImplementRelease',
      desc: '实施发布撤回'
    },
    {
      name: 'getWholeCopyClearly',
      method: 'POST',
      path: '/product/em/wholeDescribe/getWholeCopyClearly',
      mockPath: '/product/em/wholeDescribe/getWholeCopyClearly',
      desc: '获取项目附件'
    },
    {
      name: 'directRelease',
      method: 'POST',
      path: '/product/em/wholeDescribe/directRelease',
      mockPath: '/product/em/wholeDescribe/directRelease',
      desc: '立项决策管理->直接发布项目'
    },
    {
      name: 'releaseCheck',
      method: 'POST',
      path: '/product/em/wholeDescribe/releaseCheck',
      mockPath: '/product/em/wholeDescribe/releaseCheck',
      desc: '项目策划管理->项目发布校验'
    }
  ],
  projectApprove: [
    {
      name: 'selectPageAll',
      method: 'POST',
      path: '/product/pm/jxhProjectApprove/selectPageAll',
      mockPath: '/product/pm/jxhProjectApprove/selectPageAll',
      desc: '项目管理->项目立项->列表数据查询'
    }
  ],
  planInfoManager: [
    {
    ...
    {
      name: 'businessTreeListData',
      method: 'POST',
      path: '/product/pm/planManager/businessTreeListData',
      mockPath: '/product/pm/planManager/businessTreeListData',
      desc: '项目管理->计划管理->审批流程列表'
    },
    {
      name: 'updatePlans',
      method: 'POST',
      path: '/product/pm/planManager/updatePlans',
      mockPath: '/product/pm/planManager/updatePlans',
      desc: '项目管理->计划管理->修改驳回的计划状态'
    },
    {
    ...
    {
      name: 'getPackageNodeInfo',
      method: 'POST',
      path: '/product/pm/planManager/getPackageNodeInfo',
      mockPath: '/product/pm/planManager/getPackageNodeInfo',
      desc: '项目管理->计划管理->获取专有的节点信息'
    },
    {
    ...
    },
    {
      ...
      method: 'POST',
      path: '/product/pm/planManager/commitValidator',
      mockPath: '/product/pm/planManager/commitValidator',
      desc: '项目管理->计划管理->提交统筹分发校验责任人'
    },
    {
    ...
    },
    {
      name: 'updateStatus',
      method: 'POST',
      path: '/product/pm/planManager/updateStatus',
      mockPath: '/product/pm/planManager/updateStatus',
      desc: '项目管理->计划管理->获取可提交的状态集'
    },
    {
      name: 'save',
    ...
    {
      name: 'createPlanNameCheck',
      method: 'POST',
      path: '/product/pm/planManager/createPlanNameCheck',
      mockPath: '/product/pm/planManager/createPlanNameCheck',
      desc: '项目管理->计划管理->计划名称校验'
    },
    {
      name: 'withdraw',
      method: 'POST',
    ...
    },
    {
      name: 'getPlanReject',
      method: 'POST',
      path: '/product/pm/planManager/getPlanReject',
      mockPath: '/product/pm/planManager/getPlanReject',
      desc: '项目管理->计划管理->获取审批驳回意见'
    },
    {
      name: 'customGetPlanReject',
      method: 'POST',
      path: '/product/pm/planManager/customGetPlanReject',
      mockPath: '/product/pm/planManager/customGetPlanReject',
      desc: '项目管理->计划管理->获取自定义意见'
    }
  ],
  riskManager: [
    {
  ...
  productTask: [
    {
      name: 'updatePlanType',
      method: 'POST',
      path: '/product/pm/plan/updatePlanType',
      mockPath: '/product/pm/plan/updatePlanType',
      desc: '项目管理->计划管理->计划编辑->添加/查看生产计划'
    },
    {
      name: 'productTaskViewData',
      method: 'POST',
      path: '/product/pm/productTask/productTaskViewData',
      mockPath: '/product/pm/productTask/productTaskViewData',
      desc: '项目管理->计划管理->计划编辑->添加/查看生产计划'
    },
    {
      name: 'updatePlanTask',
      method: 'POST',
      path: '/product/pm/plan/updatePlanTask',
      mockPath: '/product/pm/plan/updatePlanTask',
      desc: '项目管理->计划管理->计划编辑->非生产数据数量清零'
    },
    {
      name: 'loadPlanTask',
      method: 'POST',
      path: '/product/pm/plan/loadPlanTask',
      mockPath: '/product/pm/plan/loadPlanTask',
      desc: '项目管理->计划管理->计划编辑->非生产数据加载'
    },
    {
      name: 'productTaskEditSave',
      method: 'POST',
      path: '/product/pm/productTask/productTaskEditSave',
      mockPath: '/product/pm/productTask/productTaskEditSave',
      desc: '项目管理->计划管理->计划编辑->保存生产计划信息'
    },
    {
      name: 'getProductTaskDetail',
      method: 'POST',
      path: '/product/pm/productTask/getProductTaskDetail',
      mockPath: '/product/pm/productTask/getProductTaskDetail',
      desc: '项目管理->计划管理->计划编辑->查询任务挂接产品信息明细'
    },
    {
      name: 'updateChangeData',
      method: 'POST',
      path: '/product/pm/productTask/updateChangeData',
      mockPath: '/product/pm/productTask/updateChangeData',
      desc: '项目管理->计划管理->计划编辑->添加/查看生产计划->更新产品信息数据'
    },
    {
      name: 'deleteProductPlanType',
      method: 'POST',
      path: '/product/pm/productTask/deleteProductPlanType',
      mockPath: '/product/pm/productTask/deleteProductPlanType',
      desc: '项目管理->计划管理->计划编辑->删除任务类型挂接产品数据'
    },
    {
      name: 'queryNameByType',
      method: 'POST',
      path: '/product/pm/productTask/queryNameByType',
      mockPath: '/product/pm/productTask/queryNameByType',
      desc: '项目管理->计划管理->计划编辑->检验需要添加的生产任务名称'
    }
  ],
  productInfo: [
    {
      name: 'getProductList',
      method: 'POST',
      path: '/product/pm/productInfo/getProductList',
      mockPath: '/product/pm/productInfo/getProductList',
      desc: '项目管理->计划管理->计划编辑->编辑生产计划->产品图号列表数据'
    },
    {
      name: 'checkDelete',
      method: 'POST',
      path: '/product/pm/productInfo/checkDelete',
      mockPath: '/product/pm/productInfo/checkDelete',
      desc:
        '项目管理->计划管理->计划编辑->编辑生产计划->产品图号列表数据->产品是否已被使用'
    },
    {
      name: 'removeProduct',
      method: 'POST',
      path: '/product/pm/productInfo/removeProduct',
      mockPath: '/product/pm/productInfo/removeProduct',
      desc:
        '项目管理->计划管理->计划编辑->编辑生产计划->产品图号列表数据->删除产品信息'
    },
    {
      name: 'productInfoSave',
      method: 'POST',
      path: '/product/pm/productInfo/productInfoSave',
      mockPath: '/product/pm/productInfo/productInfoSave',
      desc:
        '项目管理->计划管理->计划编辑->编辑生产计划->产品图号列表数据->保存产品信息'
    },
    {
      name: 'getProductInfo',
      method: 'POST',
      path: '/product/pm/productInfo/getProductInfo',
      mockPath: '/product/pm/productInfo/getProductInfo',
      desc:
        '项目管理->计划管理->计划编辑->编辑生产计划->产品图号列表数据->获取产品信息'
    },
    {
      name: 'importExcelCheckOut',
      method: 'POST',
      path: '/product/pm/productInfo/importExcelCheckOut',
      mockPath: '/product/pm/productInfo/importExcelCheckOut',
      desc:
        '项目管理->计划管理->计划编辑->编辑生产计划->产品图号列表数据->Excel导入检查'
    },
    {
      name: 'importExcel',
      method: 'POST',
      path: '/product/pm/productInfo/importExcel',
      mockPath: '/product/pm/productInfo/importExcel',
      desc:
        '项目管理->计划管理->计划编辑->编辑生产计划->产品图号列表数据->Excel导入'
    }
  ],
  projectTeam: [
    {
...
//   ],
  ...
  ProjectTarget: [
    {
      ...
      method: 'POST',
      path: '/product/pmProjectTarget/saveProjectTarget',
      mockPath: '/product/pmProjectTarget/saveProjectTarget',
      desc: '项目管理->整体管理->立项信息->项目目标->保存'
    },
    {
      name: 'getList',
      method: 'POST',
      path: '/product/pmProjectTarget/getList',
      mockPath: '/product/pmProjectTarget/getList',
      desc: '项目管理->整体管理->立项信息->项目目标->列表'
    }
  ],
  WorkStatistics: [
    {
    ...
    {
      name: 'taskListDataByBussinessId',
      method: 'POST',
      path: '/product/statistics/WorkStatistics/taskListDataByBussinessId',
      mockPath: '/product/statistics/WorkStatistics/taskListDataByBussinessId',
      desc: '多项目管理->任务统计查询->列表数据查询'
    },
    {
      name: 'taskListDataByBId',
      method: 'POST',
      path: '/product/statistics/WorkStatistics/taskListDataByBId',
      mockPath: '/product/statistics/WorkStatistics/taskListDataByBId',
      desc: '多项目管理->任务统计查询->列表数据查询'
    }
  ],
  PlanFinishRate: [
    {
      name: 'getPlanCompleteData',
      method: 'POST',
      path: '/product/statistics/PlanFinishRate/getPlanCompleteData',
      mockPath: '/product/statistics/PlanFinishRate/getPlanCompleteData',
      desc: '多项目管理->任务查询->列表数据查询'
    },
    {
      name: 'planCompleteList',
      method: 'POST',
      path: '/product/statistics/PlanFinishRate/planCompleteList',
      mockPath: '/product/statistics/PlanFinishRate/planCompleteList',
      desc: '多项目管理->项目计划按时完成率查询->列表数据查询'
    },
    {
      name: 'planRateList',
      method: 'POST',
  ...
  emConfig: [
    {
      name: 'list',
      method: 'POST',
      path: '/product/bpEmConfig/bpEmConfigList',
      mockPath: '/product/bpEmConfig/bpEmConfigList',
      desc: '知识库管理->立项决策配置->立项决策配置列表'
    },
    {
      name: 'save',
      method: 'POST',
      path: '/product/bpEmConfig/save',
      mockPath: '/product/bpEmConfig/save',
      desc: '知识库管理->立项决策配置->立项决策配置列表'
    },
    {
      name: 'deleteById',
      method: 'POST',
      path: '/product/bpEmConfig/deleteById',
      mockPath: '/product/bpEmConfig/deleteById',
      desc: '知识库管理->立项决策配置->删除'
    },
    {
      name: 'getById',
      method: 'POST',
      path: '/product/bpEmConfig/getById',
      mockPath: '/product/bpEmConfig/getById',
      desc: '知识库管理->立项决策配置->获取'
    },
    {
      name: 'getProjectFunction',
      method: 'POST',
      path: '/product/bpProjectFunction/getProjectFunction',
      mockPath: '/product/bpProjectFunction/getProjectFunction',
      desc: '知识库管理->立项决策配置->获取项目功能树'
    }
  ],
  contractManager: [
    {
  ...
  myExperience: [
    ...
    },
    {
      ...
      mockPath:
        '/product/repository/MyExperienceBase/experienceClassifyTreeList',
    ...
    },
    {
      ...
      method: 'POST',
      path:
        '/product/repository/MyExperienceBase/experienceClassifyCreateOrUpdate',
      mockPath:
        '/product/repository/MyExperienceBase/experienceClassifyCreateOrUpdate',
    ...
    },
    {
      ...
      method: 'GET',
      path:
        '/product/repository/MyExperienceBase/myExperienceCliassifyEditData',
      mockPath:
        '/product/repository/MyExperienceBase/myExperienceCliassifyEditData',
    ...
    },
    {
      ...
      mockPath:
        '/product/repository/MyExperienceBase/myExperienceWholeRightList',
    ...
    },
    {
      ...
      method: 'POST',
      path:
        '/product/repository/MyExperienceBase/myExperienceInfoImportRightList',
      mockPath:
        '/product/repository/MyExperienceBase/myExperienceInfoImportRightList',
  ...
  courtyardPlanManager: [
    {
      name: 'sendMessage',
      method: 'POST',
      path: '/product/pm/planWarning/sendMessage',
      mockPath: '/product/pm/planWarning/sendMessage',
      desc: '计划预警->计划预警发送信息测试'
    },
    {
      name: 'connectClassTask',
      method: 'POST',
      path: '/product/pmCourtWholeDescribe/connectClassTask',
      mockPath: '/product/pmCourtWholeDescribe/connectClassTask',
      desc: '院计划管理->所级标识 - > 添加'
    },
    {
      name: 'connectClassTaskTwo',
      method: 'POST',
      path: '/product/pmCourtWholeDescribe/connectClassTaskTwo',
      mockPath: '/product/pmCourtWholeDescribe/connectClassTaskTwo',
      desc: '院计划管理->所级标识 - > 添加2'
    },
    {
      name: 'createTaskByAvTASK',
      method: 'POST',
      path: '/product/pmCourtWholeDescribe/createTaskByAvTASK',
      mockPath: '/product/pmCourtWholeDescribe/createTaskByAvTASK',
      desc: '院计划管理->所级标识 - > 添加院计划'
    },
    {
      name: 'deleteTaskByAvTASK',
      method: 'POST',
      path: '/product/pmCourtWholeDescribe/deleteTaskByAvTASK',
      mockPath: '/product/pmCourtWholeDescribe/deleteTaskByAvTASK',
      desc: '院计划管理->所级标识 - > 删除院计划'
    },
    {
      name: 'disConnectClassTask',
      method: 'POST',
      path: '/product/pmCourtWholeDescribe/disConnectClassTask',
      mockPath: '/product/pmCourtWholeDescribe/disConnectClassTask',
      desc: '院计划管理->所级标识 - > 取消'
    },
    {
      name: 'disConnectClassTaskTwo',
      method: 'POST',
      path: '/product/pmCourtWholeDescribe/disConnectClassTaskTwo',
      mockPath: '/product/pmCourtWholeDescribe/disConnectClassTaskTwo',
      desc: '院计划管理->所级标识 - > 取消2'
    },
    {
      name: 'courtyardProjectTree',
      method: 'GET',
      path: '/product/pmCourtWholeDescribe/courtyardProjectTree',
      mockPath: '/product/pmCourtWholeDescribe/courtyardProjectTree',
      desc: '院计划管理->院项目结构树查询'
    },
    {
      name: 'courtyardProjectTreeView',
      method: 'GET',
      path: '/product/pmCourtWholeDescribe/courtyardProjectTreeView',
      mockPath: '/product/pmCourtWholeDescribe/courtyardProjectTreeView',
      desc: '院计划管理->院项目结构树查询'
    },
    {
      name: 'connectTask',
      method: 'POST',
      path: '/product/pmCourtWholeDescribe/connectTask',
      mockPath: '/product/pmCourtWholeDescribe/connectTask',
      desc: '院计划管理->关联'
    },
    {
      name: 'disConnectTask',
      method: 'POST',
      path: '/product/pmCourtWholeDescribe/disConnectTask',
      mockPath: '/product/pmCourtWholeDescribe/disConnectTask',
      desc: '院计划管理->取消关联'
    },
    {
      name: 'courtyardPlanList',
      method: 'POST',
      path: '/product/pmCourtPlanInfo/courtyardPlanList',
      mockPath: '/product/pmCourtPlanInfo/courtyardPlanList',
      desc: '院计划管理->院计划列表查询'
    },
    {
      name: 'notConectcourtyardPlanList',
      method: 'POST',
      path: '/product/pmCourtPlanInfo/notConectcourtyardPlanList',
      mockPath: '/product/pmCourtPlanInfo/notConectcourtyardPlanList',
      desc: '院计划管理->院计划列表查询 -> 未关联列表'
    },
    {
      name: 'deletePlan',
      method: 'POST',
      path: '/product/pmCourtPlanInfo/deletePlan',
      mockPath: '/product/pmCourtPlanInfo/deletePlan',
      desc: '院计划管理->院计划删除'
    },
    {
      name: 'deletePlanClassify',
      method: 'POST',
      path: '/product/pmCourtPlanInfo/deletePlanClassify',
      mockPath: '/product/pmCourtPlanInfo/deletePlanClassify',
      desc: '院计划管理->院计划删除父节点'
    },
    {
      name: 'projectTree',
    ...
    },
    {
      name: 'importExcelCheckOut',
      method: 'POST',
      path: '/product/pmCourtPlanInfo/importExcelCheckOut',
      mockPath: '/product/pmCourtPlanInfo/importExcelCheckOut',
      desc: '计划管理->excel导入检查'
    },
    {
      name: 'importExcel',
      method: 'POST',
      path: '/product/pmCourtPlanInfo/importExcel',
      mockPath: '/product/pmCourtPlanInfo/importExcel',
      desc: '项目管理->计划管理->计划编制->数据->导入excel'
    },
    {
      name: 'taskTreeList',
      method: 'POST',
      path: '/product/pmCourtPlanTasks/treeListData',
      mockPath: '/product/pmCourtPlanTasks/treeListData',
      desc: '多项目管理->任务统计查询->列表数据查询'
    },
    {
      name: 'deleteCourtTask',
      method: 'POST',
      path: '/product/pmCourtPlanTasks/deleteCourtTask',
      mockPath: '/product/pmCourtPlanTasks/deleteCourtTask',
      desc: '院计划管理->院计划删除'
    },
    {
      name: 'importTaskExcel',
      method: 'POST',
      path: '/product/pmCourtPlanTasks/importTaskExcel',
      mockPath: '/product/pmCourtPlanTasks/importTaskExcel',
      desc: '院计划管理->计划编制->数据->导入excel'
    },
    {
      name: 'importTaskExcelCheckOut',
      method: 'POST',
      path: '/product/pmCourtPlanTasks/importTaskExcelCheckOut',
      mockPath: '/product/pmCourtPlanTasks/importTaskExcelCheckOut',
      desc: '院计划管理->excel导入检查'
    }
  ],
  planCompletionRate: [
    {
      name: 'baseMointPointList',
      method: 'POST',
      path: '/product/statistics/planCompletionRate/baseMointPointList',
      mockPath: '/product/statistics/planCompletionRate/baseMointPointList',
      desc: '多项目管理->计划按时完成率->筛选加载基础标识值'
    },
    {
      name: 'hospitalLevelList',
      method: 'POST',
      path: '/product/statistics/planCompletionRate/hospitalLevelList',
      mockPath: '/product/statistics/planCompletionRate/hospitalLevelList',
      desc: '多项目管理->计划按时完成率->筛选加载基础是否院所计划'
    },
    {
      name: 'getDefaultRangeTime',
      method: 'POST',
      path: '/product/statistics/planCompletionRate/getDefaultRangeTime',
      mockPath: '/product/statistics/planCompletionRate/getDefaultRangeTime',
      desc: '多项目管理->计划按时完成率->默认初始化值'
    },
    {
      name: 'planCompletionRateList',
      method: 'POST',
      path: '/product/statistics/planCompletionRate/planCompletionRateList',
      mockPath: '/product/statistics/planCompletionRate/planCompletionRateList',
      desc: '多项目管理->计划按时完成率->计划按时完成率统计'
    },
    {
      name: 'selectAllRuleList',
      method: 'POST',
      path: '/product/statistics/planCompletionRate/selectAllRuleList',
      mockPath: '/product/statistics/planCompletionRate/selectAllRuleList',
      desc: '多项目管理->计划按时完成率->现有所有规则'
    },
    {
      name: 'saveDelayRules',
      method: 'POST',
      path: '/product/statistics/planCompletionRate/saveDelayRules',
      mockPath: '/product/statistics/planCompletionRate/saveDelayRules',
      desc: '多项目管理->计划按时完成率->设置规则'
    }
  ],
  erpTask: [
    {
      name: 'selectAttentionErpTask',
      method: 'POST',
      path: '/product/pm/erpTask/selectAttentionErpTask',
      mockPath: '/product/pm/erpTask/selectAttentionErpTask',
      desc: '计划编辑->点击生产图标->查询关注的生产任务数量'
    },
    {
      name: 'erpTaskListData',
      method: 'POST',
      path: '/product/pm/erpTask/erpTaskListData',
      mockPath: '/product/pm/erpTask/erpTaskListData',
      desc: '计划编辑->点击生产图标->查询生产计划明细表'
    },
    {
      name: 'mesTaskListData',
      method: 'POST',
      path: '/thirdPart/webservice/callMesTask/mesTaskListData',
      mockPath: '/thirdPart/webservice/callMesTask/mesTaskListData',
      desc: '计划编辑->点击生产图标->mes列表'
    },
    {
      name: 'vlpLeftListData',
      method: 'POST',
      path: '/thirdPart/webservice/callMesTask/vlpLeftListData',
      mockPath: '/thirdPart/webservice/callMesTask/vlpLeftListData',
      desc: '计划编辑->点击生产图标->mes列表'
    },
    {
      name: 'vlpRight',
      method: 'POST',
      path: '/thirdPart/webservice/callMesTask/vlpRight',
      mockPath: '/thirdPart/webservice/callMesTask/vlpRight',
      desc: '计划编辑->点击生产图标->mes列表'
    },
    {
      name: 'zlwtListData',
      method: 'POST',
      path: '/thirdPart/webservice/callMesTask/zlwtListData',
      mockPath: '/thirdPart/webservice/callMesTask/zlwtListData',
      desc: '计划编辑->点击生产图标->mes列表'
    },
    {
      name: 'erpTaskTreeData',
      method: 'POST',
      path: '/product/pm/erpTask/erpTaskTreeData',
      mockPath: '/product/pm/erpTask/erpTaskTreeData',
      desc: '计划编辑->点击生产图标->查询生产计划明细结构树'
    },
    {
      name: 'saveAttentionErpTask',
      method: 'POST',
      path: '/product/pm/erpTask/saveAttentionErpTask',
      mockPath: '/product/pm/erpTask/saveAttentionErpTask',
      desc: '计划编辑->点击生产图标->保存关注的生产任务数量'
    }
  ],
  planFlight: [
    {
      name: 'searchByTaskId',
      method: 'POST',
      path: '/product/pm/planFlight/searchByTaskId',
      mockPath: '/product/pm/planFlight/searchByTaskId',
      desc: '计划编辑->飞行试验->任务信息'
    },
    {
      name: 'save',
      method: 'POST',
      path: '/product/pm/planFlight/save',
      mockPath: '/product/pm/planFlight/save',
      desc: '计划编辑->飞行试验->保存'
    }
  ],
  planLarge: [
    {
      name: 'searchByTaskId',
      method: 'POST',
      path: '/product/pm/planLarge/searchByTaskId',
      mockPath: '/product/pm/planLarge/searchByTaskId',
      desc: '计划编辑->大型试验->任务信息'
    },
    {
      name: 'save',
      method: 'POST',
      path: '/product/pm/planLarge/save',
      mockPath: '/product/pm/planLarge/save',
      desc: '计划编辑->大型试验->保存'
    }
  ],
  thirdPath: [
    {
      name: 'callErpPlan',
      method: 'POST',
      path: '/thirdPart/webservice/product/callErpPlan',
      mockPath: '/thirdPart/webservice/product/callErpPlan',
      desc: '计划编辑->添加查看生产计划->同步生产计划'
    }
  ],
  DutyGroupTarget: [
    {
      name: 'listByDutyId',
      method: 'POST',
      path: '/product/pm-duty-group-target/listByDutyId',
      mockPath: '/product/pm-duty-group-target/listByDutyId',
      desc: ''
    },
    {
      name: 'createOrUpdate',
      method: 'POST',
      path: '/product/pm-duty-group-target/createOrUpdate',
      mockPath: '/product/pm-duty-group-target/createOrUpdate',
      desc: ''
    },
    {
      name: 'deleteByIds',
      method: 'POST',
      path: '/product/pm-duty-group-target/deleteByIds',
      mockPath: '/product/pm-duty-group-target/deleteByIds',
      desc: ''
    },
    {
      name: 'getDeptByType',
      method: 'POST',
      path: '/product/pm-duty-group-target/getDeptByType',
      mockPath: '/product/pm-duty-group-target/getDeptByType',
      desc: ''
    }
  ]
}
